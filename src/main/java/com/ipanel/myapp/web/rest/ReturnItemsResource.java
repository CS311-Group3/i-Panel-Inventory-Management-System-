...
import com.ipanel.myapp.repository.ReturnItemsRepository;
...
/**
 * REST controller for managing {@link com.ipanel.myapp.domain.ReturnItems}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ReturnItemsResource {
    ...
    public ResponseEntity<List<ReturnItems>> getAllReturnItems(Pageable pageable) {
        log.debug("REST request to get a page of ReturnItems");
        Page<ReturnItems> page = returnItemsRepository.findAll(pageable);
