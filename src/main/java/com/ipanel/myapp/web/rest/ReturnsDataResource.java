...
/**
 * REST controller for managing {@link com.ipanel.myapp.domain.ReturnsData}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ReturnsDataResource {
    ...
    public ResponseEntity<List<ReturnsData>> getAllReturnsData(Pageable pageable) {
        log.debug("REST request to get a page of ReturnsData");
        Page<ReturnsData> page = returnsDataRepository.findAll(pageable);
