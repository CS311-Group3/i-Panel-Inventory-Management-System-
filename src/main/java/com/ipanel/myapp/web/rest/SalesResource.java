...
/**
 * REST controller for managing {@link com.ipanel.myapp.domain.Sales}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class SalesResource {
    ...
    public ResponseEntity<Sales> updateSales(@RequestBody Sales sales) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, sales.getId().toString()))
            .body(result);
    }
