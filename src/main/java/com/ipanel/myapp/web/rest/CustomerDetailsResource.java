...
/**
 * REST controller for managing {@link com.ipanel.myapp.domain.CustomerDetails}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class CustomerDetailsResource {
    ...
    public CustomerDetailsResource(CustomerDetailsRepository customerDetailsRepository) {
    ...
    public ResponseEntity<CustomerDetails> updateCustomerDetails(@RequestBody CustomerDetails customerDetails) throws URISyntaxException {
    ...
    public ResponseEntity<List<CustomerDetails>> getAllCustomerDetails(Pageable pageable) {
        ...
        Page<CustomerDetails> page = customerDetailsRepository.findAll(pageable);
