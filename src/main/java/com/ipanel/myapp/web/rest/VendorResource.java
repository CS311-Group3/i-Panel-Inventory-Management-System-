...
import com.ipanel.myapp.domain.Vendor;
import com.ipanel.myapp.repository.VendorRepository;
...
/**
 * REST controller for managing {@link com.ipanel.myapp.domain.Vendor}.
 */
@RestController
@RequestMapping("/api")
@Transactional
