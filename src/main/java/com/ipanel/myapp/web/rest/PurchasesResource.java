...
import com.ipanel.myapp.repository.InventoryRepository;
import com.ipanel.myapp.repository.PurchaseItemsRepository;
import com.ipanel.myapp.repository.PurchasesRepository;
...
/**
 * REST controller for managing {@link com.ipanel.myapp.domain.Purchases}.
 */
@RestController
@RequestMapping("/api")
@Transactional
